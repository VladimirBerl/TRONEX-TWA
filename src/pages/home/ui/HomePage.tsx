...
export const HomePage = () => {
  ...
  return (
    <div className="w-full max-w-[425px] min-w-[320px] max-h-[642px] h-full">
      <div className="bg-[#111217] py-[29px] px-2.5">
        ...
        <div className="flex justify-between items-center mx-[30px]">
          <h2 className="uppercase text-[#FFFFFF] font-medium">Level</h2>
